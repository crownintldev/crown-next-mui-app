    ...
    <CanViewNavApp navLink={item}>
      ...
      >
        <MenuNavLink
          ...
          href={item.path === undefined ? '/' : `${item.path}${item.activeChildPath}`}
        ...
        >
          ...
          >
            <UserIcon icon={icon} popover={true} popoverText={item.title} fontSize='2.341rem' />
          </ListItemIcon>
...
export default VerticalNavAppLink
